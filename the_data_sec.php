...
$module_logo_arr =  array('module_logo' => $module_logo);
        ...
        "Content-Type: application/json" 
         ...
         $conn = curl_init();
         $requestURL = 'https://elastic:JlBTKzVNwt4xngGfOfnZwQIa@edicom-dac917.es.eastus2.azure.elastic-cloud.com/_bulk';
