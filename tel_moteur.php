...
<form method="get" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  <div class="col-sm-4">
  Numero telephone ou fax : <input type="text" name="quoi" value="<?php echo $quoi;?>"   required>
...
"query": {
   ...
   "query":{
           ...
           { "match": { "tel1_s" : { "query" : "'.$quoi.'" } } },
           { "match": { "tel2_s" : { "query" : "'.$quoi.'" } } },
           { "match": { "fax_s" : { "query" : "'.$quoi.'" } } }
                  ]
               }
   },
...
*/
    ...
    $curl = curl_init();
    curl_setopt($curl, CURLOPT_URL, 'https://elastic:Pm96tlWeFPzhdyBfGGXUrsfl@edicom.es.eu-west-3.aws.elastic-cloud.com/telecontact36/_search?pretty');
