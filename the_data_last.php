...
AND code_fichier  != 'O20' AND maj_k NOT IN (0,8) AND maj_n NOT IN (0,8) AND code_fichier !='N20' and  firmes.`code_firme` !='MA4445555'   "); 
...
$doc       = array_merge($doc, $villes_filter_arr);
             ...
             $sets[] = $set;
// echo 'code_firme'.$row["code_firme"].'<br/>';
...
while(   $count <= $before && $row = $sth->fetch()) {      
